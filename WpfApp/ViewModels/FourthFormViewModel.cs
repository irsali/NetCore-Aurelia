...
{
    public class FourthFormViewModel : Caliburn.Micro.Screen
    {
        public FourthFormViewModel()
        {
            OnInit();

            Fields = new BindableCollection<FourthFormFieldViewModel>();

            foreach (var formField in formFields)
            {
                Fields.Add(new FourthFormFieldViewModel(formField));
            }
        }
        ...
        public BindableCollection<FourthFormFieldViewModel> Fields { get; }
        ...
        public void Save()
        {
            ...
            {
                s.Append($"{field.MyControlViewModel.FormField.Text}: {field.MyControlViewModel.FormField.Value} {Environment.NewLine}");
            }
