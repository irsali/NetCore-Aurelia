...
{
    public class ThirdFormViewModel : Caliburn.Micro.Screen
    {

        public ThirdFormViewModel()
        {
            OnInit();
            ...
            {
                Fields.Add(new FormFieldViewModel(formField));
            }
            //{
        ...
        public void SetPositionOfFields()
        {
