...
{
    public class FifthFormViewModel : Screen
    {
        public FifthFormViewModel()
        {
            OnInit();

            Fields = new BindableCollection<FifthFormFieldViewModel>();

            foreach (var formField in formFields)
            {
                Fields.Add(new FifthFormFieldViewModel(formField));
            }
        }
        ...
        public BindableCollection<FifthFormFieldViewModel> Fields { get; }
        ...
        public void Save()
        {
            ...
            {
                s.Append($"{field.EjControlViewModel.FormField.Text}: {field.EjControlViewModel.FormField.Value} {Environment.NewLine}");
            }
